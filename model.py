...
from seq2sql_condition_predict import Seq2SQLCondPredictor
...
class Seq2SQL(nn.Module):
    ...
    def forward(self, q, col, col_num,gt_where = None, gt_cond=None, reinforce=False, gt_sel=None):
    ...
    def gen_query(self, scores, q, col, raw_q, raw_col, pred_entry, reinforce=False, verbose=False):
        ...
        for b in range(B):
            ...
            if agg_index != -1:
                ...
                col_tok = out_toks[sel_index + 1:con_index]
